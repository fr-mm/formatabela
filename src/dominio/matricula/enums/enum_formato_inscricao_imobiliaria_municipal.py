...
class EnumFormatoInscricaoImobiliariaMunicipalDeMatricula(Enum):
    ...
    AUSENTE = rf'^{EnumOpcoesCompartilhadas.AUSENTE.value}$'
    NAO_SE_APLICA = rf'^{EnumOpcoesCompartilhadas.NAO_SE_APLICA.value}$'
