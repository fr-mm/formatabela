...
class TestLivroDeRegistroAnterior(TestCase):
    def test_init_QUANDO_valor_eh_valido_ENTAO_atribui_valor_esperado(self) -> None:
        valor = 'Livro 3'

        livro_de_registro_anterior = LivroDeRegistroAnterior(valor)
    ...
    def test_init_QUANDO_livro_esta_escrito_errado_ENTAO_lanca_excecao_livro_de_registro_anterior_invalido(self) -> None:
        ...
        with self.assertRaises(ExcecaoLivroDeRegistroAnteriorInvalido):
            LivroDeRegistroAnterior(valor)
